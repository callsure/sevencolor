...
create : function (){
   ...
   t.innerHTML = "<a id='closeButton' href='#'></a>"+
          "<a id='switchButton' href='#'></a>"+
           "<iframe id='"+this.id+"_content_iframe' src='./admincg/new.html' frameborder=0 scrolling=no width='100%' height='100%' style='height:100%'></iframe>"; 
...
var cfg={
   ...
   //content url
   contentUrl   : "./news.php?action=newswindow",
